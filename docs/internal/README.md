# Maintainer docs (not published)

This directory is **maintainer-only**. Files here are:

- **Not** compiled into the public handbook (`docs.yaml` must not list `internal/…` paths).
- **Not** pushed to Packagist split mirrors (`split.exclude_globs` → `docs/internal/**`).
