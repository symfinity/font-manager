...
- Symfony configuration root key: `font_manager:` → `symfinity_font_manager:` (Symfinity bundle config naming)
...
- Upgrading from 0.2.2: rename your config file and root key, or re-apply the Flex recipe — see [docs/upgrade.md](docs/upgrade.md)
